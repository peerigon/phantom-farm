...
function spawn(phantomJsConfig) {
    ...
    return open(null)
        ...
        /**
         * Step 3: Create the actual Phantom-instance, starts the websocket server and return it.
         */
        .then(function () {
            return new Promise(function (resolve, reject) {
                var phantom = new Phantom(child);
                phantom.startLocalServer(resolve, reject);
            });
        });
}
